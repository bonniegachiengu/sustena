  ...
  return (
    <div className="panel-enter" style={{ display: 'grid', gridTemplateRows: 'auto 1fr', height: '100%', gap: 14, padding: '24px 28px' }}>
      ...
      <div style={{
        ...
        >
          <SimulatorCanvas activeNodes={activeNodes} completedNodes={completedNodes} activePath={activePath} />
        </Card>
...
function SimulatorCanvas({ activeNodes, completedNodes, activePath }) {
  const W = 920, H = 400;
