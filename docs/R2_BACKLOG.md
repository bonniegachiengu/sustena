...
| Conformance vectors | R1 parity + R2 spec, incl. **22 approval**, **26 editing**, **29 constraint**, **31 compose**, **16 version**, **15 migrate**, **20 region**, **17 detect**, **20 controller**, **18 kernel**, **16 tenet**, **18 ensemble**, **17 signal**, **16 pincer**, **17 ooda**, **17 monitor**, **15 holarchy**, **14 population**, **17 consensus**, **13 router**, **16 vclock**, **16 disaggregation**, **21 division**, **20 crdt**, **17 operative**, **16 goodhart+presentation**, **14 mixture**, **16 criticality**, **15 cynefin**, **15 boundary**, **14 flow** cases (divergences recorded) |
| Rust tests | **656 unit · 417 conformance tests** across 32 binaries — all green |
