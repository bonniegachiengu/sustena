...
MOCK_RESPONSES: dict[str, str] = {
    ...
    "burn": "Burn rate is KES 340/day against a KES 420/day ceiling. You're on track but Vyyb procurement next week will push you close.",
    "status": "All systems nominal. 3 operatives active, no constraint breaches, council quorum met. Vyyb dispatch is live.",
    "vyyb": "Vyyb is running. Last delivery: Monday 09:14. Curator has a restock alert — cooking oil below 2L threshold. Awaiting your council vote.",
